...
class Rules() : HomeCenter(false ) {
    ...
    init {
        ...
        var rulestext = Label(
            "1. Equipment : The base game includes 16 numbered pickomino dice ranging from 21 to 36, one \"21\" tile, eight \"X5\" tiles (with worms), and a game board.\n\n" +
                "2. Objective : The goal of the game is to score the most points by collecting pickominos with high values.\n\n" +
                "3. Setup : Place the 16 pickomino dice on the game board with their faces visible. Distribute 8 \"X5\" tiles (worms) to each player and place the \"21\" tile in the center of the board.\n\n" +
                "4. Gameplay:\n" +
        ...
        bp.center = rulestext
        bp.padding = Insets(100.0,0.0,0.0,0.0)
        this.children.addAll(title,bp)
